...
document.getElementById('finish-btn').addEventListener('click', function () {
    ...
    if (name && address) {
        ...
        const whatsappWebURL = 'https://web.whatsapp.com/send?phone=' + telefone + '&text=' + encodeURIComponent(message);
        
        // URL base para o WhatsApp Mobile
        const whatsappMobileURL = 'https://wa.me/' + telefone + '?text=' + encodeURIComponent(message);
